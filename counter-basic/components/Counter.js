...
class Counter extends Component{
    render (){
        const {vrijednost, inkrementiraj, dekrementiraj} = this.props;
        const {inkrementirajNeparan, inkrementirajAsinhrono, inkrementirajAsinhronoNeparan} = this.props;
...
Counter.propTypes = {
    vrijednost: PropTypes.number.isRequired,
